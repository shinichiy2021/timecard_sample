...
(function($, undefined) {
    ...
    function Ympicker() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            dayNamesMin: ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'gaia_kanri'], // Column headings for days starting at Sunday
        ...
        _doKeyDown: function(event) {
            ...
            if ($.ympicker._ympickerShowing)
                switch (event.keyCode) {
                    ...
                    case 13:
                        var sel = $('td.' + $.ympicker._dayOverClass + ':not(.' +
...
// 日付表示関数
//============================================
function dateDisplay(ymdALocal, ymdBLocal) {
    var week = ["日", "月", "火", "水", "木", "金", "土"];
    var ym = $("#ym").val();
    var sd = new Date(ymdALocal);
    var ed = new Date(ymdBLocal);
    $("#psd").val(ymdALocal);
    $("#ped").val(ymdBLocal);
    var yyyy = ym.split("/")[0];
    var mmmm = ym.split("/")[1];
    $("#displayDate").html(yyyy + "年" + parseInt(mmmm, 10) + "月分");
}