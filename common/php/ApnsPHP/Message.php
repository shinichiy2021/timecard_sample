...
{
	const PAYLOAD_MAXIMUM_SIZE = 512; /**< @type integer The maximum size allowed for a notification payload. */
	...
	{
		// 2017/09/09 yamazaki
		// 使用できないpush通知が存在する場合は、その処理での例外を出さない様にする。
		// 例外を出してしまうとその後の通知が送られないため。
